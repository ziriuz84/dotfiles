...
_G.packer_plugins = {
  ...
  ["trouble.nvim"] = {
    commands = { "Trouble" },
    config = { "\27LJ\2\n{\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\5\15auto_close\2\14auto_open\2\vheight\3\n\25use_diagnostic_signs\2\fpadding\1\nsetup\ftrouble\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au BufNew * ++once lua require("packer.load")({'ssr.nvim', 'lsp_signature.nvim'}, { event = "BufNew *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'editorconfig-vim', 'gitsigns.nvim', 'Comment.nvim', 'todo-comments.nvim', 'hop.nvim', 'twilight.nvim', 'nvim-bqf', 'zen-mode.nvim', 'nvim-spectre', 'lsp_signature.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'ssr.nvim', 'symbols-outline.nvim', 'vim-matchup', 'nvim-ts-context-commentstring'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
